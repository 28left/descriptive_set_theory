...
Suppose $<_W \subseteq \Real\times\Real$ is a well-ordering of $\Real$ of order-type $\omega_1$ in $\Gamma$, then there exists a subset of $\Real$ in $\Gamma$ that is neither Lebesgue measurable nor has the Baire property.
```
