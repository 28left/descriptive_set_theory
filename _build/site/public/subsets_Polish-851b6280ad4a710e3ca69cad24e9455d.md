...
What about open subsets like $(0,1) \subset \Real$? In this case we have to find a different compatible metric.
...
Any open subset of a Polish space $X$ is Polish (with respect to the subset topology).
```
