...
$$
Let $U \subseteq X$ be open. Then $d(x , X\setmiuns U)$ is strictly positive.
...
$$
This is a metric on $U$ compatible with the subspace topology and with respect to which $U$ is complete. 
```
