...
Show that in this case there exists $\delta < \aleph_\alpha$ with $F(\delta\times \delta) \subseteq \aleph_\alpha$ and hence $|\delta \times \delta| \geq \aleph_\alpha$. Argue that this contradicts the minimality of $\alpha$.
```
