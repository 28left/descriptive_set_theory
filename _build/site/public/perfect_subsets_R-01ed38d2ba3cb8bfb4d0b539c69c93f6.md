...
::: {#046dbdd4-793b-4f3d-b8e7-5e11aeed89d2 .cell .markdown}
...
For closed sets, the situation is less clear. Given a set $A \subseteq \Real$, we call $x \in \Real$ an **limit point** of $A$ if
...
Let $D$ be the set of all condensation points of $C$. Note that $D \subseteq C$, since every condensation point is clearly an limit point and $C$ is closed.
...
::: {#b4c79fd9-fef1-47ce-846d-30b32a9ffa67 .cell .code}
``` python
```
:::