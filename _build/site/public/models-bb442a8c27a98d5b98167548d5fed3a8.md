...
A formula ${}\varphi$ is $\pmb{\Delta_0}$ if it has no quantifiers or every quantifier of ${}\varphi$ is of the form $\exists x \in y$ or $\forall x \in y$ (i.e. every quantifier is *bounded*).
::: 
