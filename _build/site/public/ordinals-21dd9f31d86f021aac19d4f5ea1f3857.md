...
- $\omega$ is also the first instance of a **limit ordinal**: A **successor ordinal** is any ordinal of the form $\alpha+1$. Any ordinal that is not a successor is called a *limit ordinal*. $\omega$ is limit since
$$
    \omega \neq 0 \: \wedge \: \forall \alpha < \omega \; (\alpha+1 < \omega).
$$
