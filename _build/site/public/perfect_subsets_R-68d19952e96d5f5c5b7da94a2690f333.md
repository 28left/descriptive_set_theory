(perfect)=
# Warmup: Perfect Subsets of the Real Line
...
```{prf:conjecture} Continuum Hypothesis (Cantor, 1890s)
:class: hint
:icon: false
...
2. If $\tau$ is a proper extension of $\sigma$, then $\Cl{U_\tau} \subseteq U_\sigma$.
