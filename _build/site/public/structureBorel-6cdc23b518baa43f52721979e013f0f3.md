...
However, we can also argue via definability, since by {prf:ref}`prop-product-continuous` @Polish one can represent a continuous function through a monotone mapping ${}\psi$ from finite strings to finite strings.  We have
$$
