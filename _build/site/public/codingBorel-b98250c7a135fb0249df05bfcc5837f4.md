...
- On the other hand, if $k \in \Nat$ and $\alpha \in \Baire$, we obtain a new element of $\Baire$ by **concatenating** $k$ and ${}\alpha$. We will use $(k, \alpha)$ to denote this new element of $\Baire$.
