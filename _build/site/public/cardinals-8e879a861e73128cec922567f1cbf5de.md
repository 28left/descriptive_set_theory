...
An ordinal $\kappa$ is a **cardinal** if it is the cardinality of some set. Equivalently, $\kappa$ is a carindal if 
$$
...
While every cardinal is an ordinal, not every ordinal is a cardinal. They agree for the *finite sets*, i.e. those sets $a$ for which there exists an $n \in \omega$ such that
$$
n = \{0, \dots, n-1\} \sim a.
$$
...
We can use ordinals to enumerate all cardinals. This the **aleph**-sequence.
